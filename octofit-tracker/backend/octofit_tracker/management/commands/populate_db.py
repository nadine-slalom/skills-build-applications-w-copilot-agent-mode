...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        Workout.objects.create(user=batman, description='Leg workout', calories=250)
        Workout.objects.create(user=superman, description='Cardio', calories=400)
        Workout.objects.create(user=captain, description='Core workout', calories=200)
